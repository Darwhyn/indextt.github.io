...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Ahhhh  soy el hombre mas feliz del mundo ';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#9bfab0;';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'bromita, POR FAVOR DI SÍ';
            document.getElementById('noBtn').style.backgroundColor = '#9bfab0;';
